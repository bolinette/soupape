...
class ServiceCollection:
    ...
    @overload
    def add_singleton[**P, IntrT](self, resolver: ResolutionFunction[P, IntrT], /) -> None: ...
    @overload
    def add_singleton[**P, IntrT](self, interface: type[IntrT], resolver: ResolutionFunction[P, IntrT], /) -> None: ...
    ...
    @overload
    def add_scoped[**P, IntrT](self, resolver: ResolutionFunction[P, IntrT], /) -> None: ...
    @overload
    def add_scoped[**P, IntrT](self, interface: type[IntrT], resolver: ResolutionFunction[P, IntrT], /) -> None: ...
    ...
    @overload
    def add_transient[**P, IntrT](self, resolver: ResolutionFunction[P, IntrT], /) -> None: ...
    @overload
    def add_transient[**P, IntrT](self, interface: type[IntrT], resolver: ResolutionFunction[P, IntrT], /) -> None: ...
